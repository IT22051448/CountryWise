...
const AuthWelcome = () => {
  return (
    <div
      ...
      className="hidden sm:flex sm:w-1/2 lg:w-2/5 bg-gradient-to-br from-green-600 to-green-400 p-6 sm:p-8 items-center justify-center"
    >
      <div className="text-center">
        {/* icon */}
        <svg
          className="w-12 h-12 sm:w-16 sm:h-16 mx-auto text-white"
          fill="none"
          stroke="currentColor"
          viewBox="0 0 24 24"
          xmlns="http://www.w3.org/2000/svg"
          data-testid="welcome-svg"
        >
          <path
            strokeLinecap="round"
        ...
        {/* title */}
        <h3 className="text-white text-xl sm:text-2xl font-bold mt-4">
          Welcome Back to CountryWise
        </h3>

        ...
        {countries.map((country) => {
          ...
          return (
            <motion.div
              ...
              className="flex flex-col cursor-pointer bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300 border border-gray-200"
            >
              {/* Flag & Region */}
              <div className="relative h-48 sm:h-56 md:h-64 bg-gradient-to-br from-blue-50 to-blue-100 flex items-center justify-center p-2">
                <img
